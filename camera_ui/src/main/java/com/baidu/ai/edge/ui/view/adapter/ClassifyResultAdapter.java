...
public class ClassifyResultAdapter extends ArrayAdapter<DetectResultModel> {
    ...
    public ClassifyResultAdapter(@NonNull Context context, int resource, @NonNull List<DetectResultModel> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        DetectResultModel model = (DetectResultModel) getItem(position);
