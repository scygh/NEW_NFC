...
public class DetectResultAdapter extends ArrayAdapter<DetectResultModel> {
    ...
    public DetectResultAdapter(@NonNull Context context, int resource, @NonNull List<DetectResultModel> objects) {
